 // Data for the cards
 const cardData = [
    { name: 'Maria', jobName:'Designer Gráfica', imgUrl: './img/testimonial-1.png',  testimonial: `"A planilha de precificação foi um divisor de águas na minha carreira de designer. Finalmente, consigo compreender e valorizar meu trabalho de maneira justa. Uma ferramenta indispensável para todos os colegas de profissão!"` },
